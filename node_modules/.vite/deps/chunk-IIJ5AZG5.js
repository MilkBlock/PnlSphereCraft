...
var NonceContext = (0, import_react16.createContext)({
  getNonce: () => 0,
  fastRefreshes: 0,
  manualRefreshes: 0
});
var SetNonceContext = (0, import_react16.createContext)({
  increaseManualRefreshes: () => {
  }
});
var useNonce = () => {
  const context = (0, import_react16.useContext)(NonceContext);
  const [nonce, setNonce] = (0, import_react16.useState)(() => context.getNonce());
  const lastContext = (0, import_react16.useRef)(context);
...
var LogLevelContext = (0, import_react18.createContext)({
  logLevel: "info",
  mountTime: 0
});
var useLogLevel = () => {
...
var DelayRenderContextType = (0, import_react17.createContext)(null);
var useDelayRender = () => {
  const environment = useRemotionEnvironment();
  const scope = (0, import_react17.useContext)(DelayRenderContextType) ?? (typeof window !== "undefined" ? window : void 0);
  const logLevel = useLogLevel();
  const delayRender2 = (0, import_react17.useCallback)((label2, options) => {
    if (!scope) {
      return Math.random();
    }
    return delayRenderInternal({
  ...
  const continueRender2 = (0, import_react17.useCallback)((handle) => {
    if (!scope) {
      return;
    }
    continueRenderInternal({
  ...
  const cancelRender2 = (0, import_react17.useCallback)((err) => {
...
var TimelineContextProvider = ({ children, frameState }) => {
  ...
  return (0, import_jsx_runtime7.jsx)(TimelineContext.Provider, {
    value: timelineContextValue,
    children: (0, import_jsx_runtime7.jsx)(SetTimelineContext.Provider, {
...
var CanUseRemotionHooksProvider = ({ children }) => {
  return (0, import_jsx_runtime8.jsx)(CanUseRemotionHooks.Provider, {
    value: true,
    children
  });
};
...
var Freeze = ({
  ...
  return (0, import_jsx_runtime9.jsx)(TimelineContext.Provider, {
    value: timelineValue,
    children: (0, import_jsx_runtime9.jsx)(SequenceContext.Provider, {
...
var RegularSequenceRefForwardingFunction = ({
  ...
  return (0, import_jsx_runtime10.jsx)(SequenceContext.Provider, {
    value: contextValue,
    children: content === null ? null : other.layout === "none" ? content : (0, import_jsx_runtime10.jsx)(AbsoluteFill, {
      ref,
      style: defaultStyle,
      className: other.className,
      children: content
...
var PremountedPostmountedSequenceRefForwardingFunction = (props, ref) => {
  ...
  return (0, import_jsx_runtime10.jsx)(Freeze, {
    frame: freezeFrame,
    active: isFreezingActive,
    children: (0, import_jsx_runtime10.jsx)(Sequence, {
      ref,
      from,
      durationInFrames,
      style,
...
var SequenceRefForwardingFunction = (props, ref) => {
  ...
  if (props.layout !== "none" && !env.isRendering) {
    if (props.premountFor || props.postmountFor) {
      return (0, import_jsx_runtime10.jsx)(PremountedPostmountedSequence, {
        ...props,
        ref
      });
    }
  }
  return (0, import_jsx_runtime10.jsx)(RegularSequence, {
    ...props,
    ref
  });
};
...
var AnimatedImage = (0, import_react24.forwardRef)(({
  ...
  return (0, import_jsx_runtime12.jsx)(Canvas, {
    ref,
    width,
    height,
    fit,
...
var RenderAssetManagerProvider = ({ children, collectAssets }) => {
  ...
  return (0, import_jsx_runtime13.jsx)(RenderAssetManager.Provider, {
    value: contextValue,
    children
  });
};
...
var Loop = ({ durationInFrames, times = Infinity, children, name, ...props }) => {
  ...
  return (0, import_jsx_runtime14.jsx)(LoopContext.Provider, {
    value: loopContext,
    children: (0, import_jsx_runtime14.jsx)(Sequence, {
      durationInFrames,
      from,
      name: name ?? "<Loop>",
      _remotionInternalLoopDisplay: loopDisplay,
...
var PrefetchProvider = ({ children }) => {
  ...
  return (0, import_jsx_runtime15.jsx)(PreloadContext.Provider, {
    value: _preloads,
    children
  });
};
...
var DurationsContextProvider = ({ children }) => {
  ...
  return (0, import_jsx_runtime16.jsx)(DurationsContext.Provider, {
    value,
    children
  });
};
...
var SharedAudioContextProvider = ({ children, numberOfAudioTags, audioLatencyHint, audioEnabled }) => {
  ...
  return (0, import_jsx_runtime17.jsxs)(SharedAudioContext.Provider, {
    value,
    children: [
      refs.map(({ id, ref }) => {
...
var BufferingProvider = ({ children }) => {
  ...
  return (0, import_jsx_runtime18.jsx)(BufferingContextReact.Provider, {
    value: bufferManager,
    children
  });
};
...
var AudioForDevelopmentForwardRefFunction = (props, ref) => {
  ...
  const id = (0, import_react33.useMemo)(() => `audio-${random(src ?? "")}-${sequenceContext == null ? void 0 : sequenceContext.relativeFrom}-${sequenceContext == null ? void 0 : sequenceContext.cumulatedFrom}-${sequenceContext == null ? void 0 : sequenceContext.durationInFrames}-muted:${props.muted}-loop:${props.loop}`, [
    src,
...
var AudioForRenderingRefForwardingFunction = (props, ref) => {
  ...
  const { delayRender: delayRender2, continueRender: continueRender2 } = useDelayRender();
  const id = (0, import_react49.useMemo)(() => `audio-${random(props.src ?? "")}-${sequenceContext == null ? void 0 : sequenceContext.relativeFrom}-${sequenceContext == null ? void 0 : sequenceContext.cumulatedFrom}-${sequenceContext == null ? void 0 : sequenceContext.durationInFrames}`, [
    props.src,
    sequenceContext == null ? void 0 : sequenceContext.relativeFrom,
    sequenceContext == null ? void 0 : sequenceContext.cumulatedFrom,
    sequenceContext == null ? void 0 : sequenceContext.durationInFrames
...
var AudioRefForwardingFunction = (props, ref) => {
  ...
  if (loop && durationFetched !== void 0) {
    if (!Number.isFinite(durationFetched)) {
      return (0, import_jsx_runtime21.jsx)(Html5Audio, {
        ...propsOtherThanLoop,
        ref,
    ...
    return (0, import_jsx_runtime21.jsx)(Loop, {
      layout: "none",
      ...
      children: (0, import_jsx_runtime21.jsx)(Html5Audio, {
        ...propsOtherThanLoop,
        ref,
        _remotionInternalNativeLoopPassed: true
      })
  ...
  if (typeof trimBeforeValue !== "undefined" || typeof trimAfterValue !== "undefined") {
    return (0, import_jsx_runtime21.jsx)(Sequence, {
      layout: "none",
  ...
  if (environment.isRendering) {
    return (0, import_jsx_runtime21.jsx)(AudioForRendering, {
      onDuration,
      ...props,
      ref,
  ...
  return (0, import_jsx_runtime21.jsx)(AudioForPreview, {
...
var Folder = ({ name, children }) => {
  ...
  return (0, import_jsx_runtime22.jsx)(FolderContext.Provider, {
    value,
    children
  });
};
...
var Loading = () => {
  return (0, import_jsx_runtime23.jsxs)(AbsoluteFill, {
    style: container,
    id: "remotion-comp-loading",
    children: [
      (0, import_jsx_runtime23.jsx)("style", {
        type: "text/css",
        children: `
				@keyframes anim {
					from {
...
var InnerComposition = ({
  ...
  if (environment.isStudio && video && video.component === lazy && video.id === id) {
    ...
    return (0, import_react_dom.createPortal)((0, import_jsx_runtime24.jsx)(CanUseRemotionHooksProvider, {
      children: (0, import_jsx_runtime24.jsx)(import_react50.Suspense, {
        fallback: (0, import_jsx_runtime24.jsx)(Loading, {}),
        children: (0, import_jsx_runtime24.jsx)(Comp, {
  ...
  if (environment.isRendering && video && video.component === lazy && video.id === id) {
    ...
    return (0, import_react_dom.createPortal)((0, import_jsx_runtime24.jsx)(CanUseRemotionHooksProvider, {
      children: (0, import_jsx_runtime24.jsx)(import_react50.Suspense, {
        fallback: (0, import_jsx_runtime24.jsx)(Fallback, {}),
        children: (0, import_jsx_runtime24.jsx)(Comp, {
          ...resolved.result.props ?? {}
        })
      })
...
var Composition = (props2) => {
  ...
  return (0, import_jsx_runtime24.jsx)(InnerComposition, {
    ...props2
  });
};
...
var RemotionRootContexts = ({
  ...
  const [fastRefreshes, setFastRefreshes] = (0, import_react59.useState)(0);
  const [manualRefreshes, setManualRefreshes] = (0, import_react59.useState)(0);
  ...
  const setNonceContext = (0, import_react59.useMemo)(() => {
    return {
      increaseManualRefreshes: () => {
  ...
  return (0, import_jsx_runtime29.jsx)(LogLevelContext.Provider, {
    ...
    children: (0, import_jsx_runtime29.jsx)(NonceContext.Provider, {
      value: nonceContext,
      children: (0, import_jsx_runtime29.jsx)(SetNonceContext.Provider, {
...
var OffthreadVideoForRendering = ({
  ...
  const id = (0, import_react63.useMemo)(() => `offthreadvideo-${random(src)}-${sequenceContext == null ? void 0 : sequenceContext.cumulatedFrom}-${sequenceContext == null ? void 0 : sequenceContext.relativeFrom}-${sequenceContext == null ? void 0 : sequenceContext.durationInFrames}`, [
    src,
    sequenceContext == null ? void 0 : sequenceContext.cumulatedFrom,
    sequenceContext == null ? void 0 : sequenceContext.relativeFrom,
    sequenceContext == null ? void 0 : sequenceContext.durationInFrames
...
var VideoForRenderingForwardFunction = ({
  ...
  const id = (0, import_react72.useMemo)(() => `video-${random(props2.src ?? "")}-${sequenceContext == null ? void 0 : sequenceContext.cumulatedFrom}-${sequenceContext == null ? void 0 : sequenceContext.relativeFrom}-${sequenceContext == null ? void 0 : sequenceContext.durationInFrames}`, [
    props2.src,
    sequenceContext == null ? void 0 : sequenceContext.cumulatedFrom,
    sequenceContext == null ? void 0 : sequenceContext.relativeFrom,
    sequenceContext == null ? void 0 : sequenceContext.durationInFrames
...
//# sourceMappingURL=chunk-IIJ5AZG5.js.map
